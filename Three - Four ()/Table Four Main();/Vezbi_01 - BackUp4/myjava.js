...
$(document).on('click', '.edit', function (event) {
  ...
  //  let myInputSeries = "<input class='in_series' type='text' value='"+((books[index].series ? `${books[index].seriesNumber} #${books[index].series}` : ``))+"'>";
    let haha =   books[index].series ? "<input class='in_series_number' type='text' value='"+books[index].seriesNumber+"'>" + "<input class='in_series' type='text' value='"+books[index].series+"'>"  : ""
...
$(document).on('click', '.save', function (event) {
   ...
   // books[index].series = row.find('.in_series').val();
    // row.find('.in_series').val() != "undefined" ? books[index].series = row.find('.in_series').val() : "moo";
    // books[index].series = (row.find('.in_series').val() ? books[index].series = row.find('.in_series').val() : ``);

    //(books[index].series ? books[index].seriesNumber = row.find('.in_series_number').val() + books[index].series = row.find('.in_series').val() : ``)
    ...
    let haha = (books[index].series ? `${books[index].seriesNumber} #${books[index].series}` : ``);
    ...
    row.find('.td-series').html( haha)
  //  row.find('.td-series').html( (books[index].series ? `${books[index].seriesNumber} #${books[index].series}` : ``))
