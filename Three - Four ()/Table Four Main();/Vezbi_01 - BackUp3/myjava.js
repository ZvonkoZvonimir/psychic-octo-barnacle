...
$(document).on('click', '.del', function (event) {
    ...
    let _title = row.find('.td-title').text();
    let _year = row.find('.td-year').text();

    let index;
    index = books.findIndex(n => n.title==_title  && n.year==_year);
...
$(document).on('click', '.save', function (event) {
   ...
   // books[index].series = row.find('.in_series').val();
    ...
    (books[index].series ? `${books[index].seriesNumber} #${books[index].series}` : ``)
