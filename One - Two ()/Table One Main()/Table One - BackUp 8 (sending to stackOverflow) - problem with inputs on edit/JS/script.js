    ...
    function dontCoptThatFloppy(id, first, last, email, password, phone) {
        ...
        "<button class='edit-Btn'>edit</button><button class='fav-Btn'>O</button></td>"+ 
        "<td class='td-del'><button class='del-row'>Del</button></td>"+"</tr>")

        return proactiveBitch;
    }

    function outOfBodyExperience(_name){
        let perfectlyPeaceful = ("<tr><td class='fav-td'>"+_name+"</td></tr>")
        return perfectlyPeaceful;
    }
    ...
    $(document).ready(function(){
        ...
        let fav_contacts = [];
            ...
            $(document).on('click', '.fav-Btn', function (event) {
                ...
                let fav = (a_contacts.filter( obj => obj.id == idd))
                fav_contacts.push(fav[0]);
                
                $("#fav-table").append(outOfBodyExperience(fav[0].first));
            })
            ...
            $(document).on('click', '#sup_fav', function (event) {
