...
let new_contacts_arr_obj = contacts_arr_obj;
    $('#new-row-btn').click(function(){
        ...
        //  makeNewRow(idCounter, newContact.first, newContact.last, newContact.email, newContact.password, newContact.phone)
...
//======================================================================================
        ...
        // let asd = dontCoptThatFloppy( id, my_input_f_Name, my_input_l_Name, my_input_e_mail, my_input_pass, my_input_phone);

        //  $(this).closest('tr').html(asd);
        //  $(this).closest('tr').parent().html(asd);
        //  $(this).closest('tr').html(choose_your_poison);
        //  $(this).closest('tr').html(dontCoptThatFloppy( id, my_input_f_Name, my_input_l_Name, my_input_e_mail, my_input_pass, my_input_phone));
        //  $(this).closest('tr').html(makeNewRow(1, 2, 34, 5, 6, 7));
//==================================================================================
//==================================================================================
        // var $row =
