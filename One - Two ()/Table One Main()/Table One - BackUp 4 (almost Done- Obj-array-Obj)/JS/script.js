...
let a_contacts = [];
    $('#new-row-btn').click(function(){
        ...
        var newContact = new Contact($("#name-input").val(), $("#lastname-input").val(), $("#email-input").val(), $("#pass-input").val(), $("#phone-input").val());
...
var contacts_arr_obj = id_array.map(function(_,i) {
	return {
	  id: id_array[i],
