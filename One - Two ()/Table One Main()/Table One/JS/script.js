...
let new_contacts_arr_obj = contacts_arr_obj;
    $('#new-row-btn').click(function(){
        ...
        let newContact = new Contact($("#name-input").val(), $("#lastname-input").val(), $("#email-input").val(), $("#pass-input").val(), $("#phone-input").val());
...
//===================================================================
    ...
    $(document).on('click', '#sup', function (event) {
        ...
        // if(a_contacts instanceof Contact){

        // }
        a_contacts[0] instanceof Contact ? console.log(a_contacts):false;
        a_contacts2[0] instanceof Contact ? console.log(a_contacts2):false;
        // console.log(a_contacts);
        // console.log(a_contacts2);
